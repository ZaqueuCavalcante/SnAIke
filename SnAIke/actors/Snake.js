class Snake {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
  move() {
    let headX = this.head.position.x;
    let headY = this.head.position.y;
    this.head.move();
    let lastBodyPixel = this.body.pop();
    lastBodyPixel.setPosition(headX, headY);
    this.body.unshift(lastBodyPixel);
